...
const SwiperSlideData = [
  ...
  const ListData = [
    {
      ...
      content: "Lorem ipsum dolor consectetur adipiscing do eiusmod tempor incididunt labore.",
    },
    {
      icon: "fas fa-check",
  ...
  const blogClassicData = blogData.filter((item) => item.blogType === "classic").filter(item => item.category.includes("travelagency"));
    ...
    return (
      <div style={props.style}>
        ...
        <Header topSpace={{ md: true }} type="reverse-scroll">
          <HeaderNav theme="dark" fluid="fluid" expand="lg" containerClass="sm:!px-0" className="py-[0px] border-b border-[#ffffff1a] px-[35px] md:pr-[15px] md:pl-0 md:py-[20px]">
            ...
            <Col xs="auto" lg={2} className="nav-bar-contact text-end xs:hidden pe-0">
              <a aria-label="link for top" href="#top" className="text-md text-[#fff] font-serif font-medium md:text-[#000]">
        ...
        <div className="bg-white">
          ...
          <section className="py-[80px] border-b border-mediumgray bg-white md:py-[40px]">
            <Container>
              <Row className="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-center gap-y-10">
                <Col>
                  <m.div className="flex justify-start text-left items-center" {...{ ...fadeIn, transition: { delay: 0.2 } }}>
                    <div className="feature-box-icon flex items-center">
                      <i className="line-icon-Headset text-[35px] text-neonorange mr-[30px]"></i>
                    </div>
                    <div className="leading-[22px]">
                      <div className="text-[#262b35] font-serif font-medium leading-[20px] mb-[5px]">Expert support</div>
                      <span>Contact support team</span>
                    </div>
                  </m.div>
                </Col>
                <Col>
                  <m.div className="flex justify-start text-left items-center" {...{ ...fadeIn, transition: { delay: 0.4 } }}>
                    <div className="feature-box-icon flex items-center">
                      <i className="line-icon-Compass-3 text-[35px] text-neonorange mr-[30px]"></i>
                    </div>
                    <div className="leading-[22px]">
                      <div className="text-[#262b35] font-serif font-medium leading-[20px] mb-[5px]">Peaceful places</div>
                      <span>Safe and trustworthy </span>
                    </div>
                  </m.div>
                </Col>
                <Col>
                  <m.div className="flex justify-start text-left items-center" {...{ ...fadeIn, transition: { delay: 0.6 } }}>
                    <div className="feature-box-icon flex items-center">
                      <i className="line-icon-Administrator text-[35px] text-neonorange mr-[30px]"></i>
                    </div>
                    <div className="leading-[22px]">
                      <div className="text-[#262b35] font-serif font-medium leading-[20px] mb-[5px]">Exclusive agent</div>
                      <span>Leading travel agency </span>
                    </div>
                  </m.div>
                </Col>
                <Col>
                  <m.div className="flex justify-start text-left items-center" {...{ ...fadeIn, transition: { delay: 0.8 } }}>
                    <div className="feature-box-icon flex items-center">
                      <i className="line-icon-Coin text-[35px] text-neonorange mr-[30px]"></i>
                    </div>
                    <div className="leading-[22px]">
                      <div className="text-[#262b35] font-serif font-medium leading-[20px] mb-[5px]">Incredible price</div>
          ...
          {/* Section Start */}
          <m.section className="py-[130px] overflow-hidden bg-lightgray lg:py-[90px] md:py-[75px] sm:py-[50px]" {...fadeIn}>
            <Container>
              <Row className="mb-24 md:mb-20 items-center">
                <Col lg={6} md={7} className="xs:text-center sm:mb-[10px] sm:text-center">
                  <h2 className="heading-5 font-serif font-semibold text-darkgray uppercase mb-[5px] -tracking-[1px]">Top destination</h2>
                  <p className="m-0 block">This is the most popular destination in the last month</p>
                </Col>
                <Col lg={6} md={5} className="text-right sm:text-center">
                  <Buttons ariaLabel="link for destinations" href="#" className="font-medium font-serif uppercase btn-link after:h-[2px] md:text-md after:bg-darkgray hover:text-darkgray" size="xl" color="#232323" title="all destinations" />
                </Col>
              </Row>
              <InteractiveBanners07 animation={fadeIn} animationDelay={0.1} grid="row-cols-1 row-cols-lg-4 row-cols-sm-2 gap-y-[30px]" className="justify-center" />
            </Container>
          </m.section>
          {/* Section End */}
  
          {/* Text Slider Section Start */}
          <m.section className="pb-0 py-[130px] overflow-hidden bg-white lg:py-[90px] md:py-[75px] sm:py-[50px]" {...fadeIn}>
          ...
          <m.section className="py-[130px] overflow-hidden cover-background lg:py-[90px] md:py-[75px] sm:py-[50px]" style={{ backgroundImage: `url(https://via.placeholder.com/1920x826)` }} {...fadeIn}>
            <Container>
              <Row className="justify-center">
                <Col lg={7} sm={8} xl={6} className="text-center mb-24 md:mb-20">
                  <h2 className="heading-5 font-serif font-semibold text-darkgray -tracking-[1px] uppercase mb-0">Choose the perfect trip with your incredible interests</h2>
                </Col>
              </Row>
              <InteractiveBanners09 grid="row-cols-1 row-cols-sm-2 row-cols-lg-4 gap-y-10" animation={zoomIn} animationDelay={0.1} animationDuration={0.6} />
              <Row className="mt-24 xs:mt-16">
                <Col lg={12} className="text-center">
                  <Buttons ariaLabel="Explore your interests" href="#" className="font-medium font-serif uppercase btn-link after:h-[2px] lg:text-md after:bg-darkgray hover:text-darkgray" color="#232323" title="Explore your interests" size="xl" />
                </Col>
              </Row>
            </Container>
          </m.section>
            ...
            <Container className="relative">
              <Row className="mb-24 md:mb-20 items-center">
                <m.div className="text-left sm:text-center sm:mb-[10px] col-lg-6 col-md-7" {...{ ...fadeIn, transition: { delay: 0.2 } }}>
                  <h2 className="heading-5 font-serif font-semibold text-darkgray uppercase mb-[5px] -tracking-[1px]">POPULAR PACKAGES</h2>
                  <p className="m-0 block">Amazing tours and fun adventures waiting for you</p>
                </m.div>
                <m.div className="text-right sm:text-center col-lg-6 col-md-5" {...{ ...fadeIn, transition: { delay: 0.4 } }}>
                  <Buttons ariaLabel="link for packages" href="#" className="font-medium font-serif uppercase btn-link after:h-[2px] lg:text-md after:bg-darkgray hover:text-darkgray" size="xl" color="#232323" title="All packages" />
                </m.div>
              </Row>
          ...
          <section className="relative overflow-hidden py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px] px-28 bg-white lg:p-[90px] lg:px-8 xl:px-8 xs:px-0">
            <Container fluid>
              <Row className="items-center justify-center">
                <m.div className="relative lg:mb-20 lg:text-center col-xl-3 col-lg-9 col-md-8" {...{ ...fadeIn, transition: { delay: .2 } }}>
                  <h2 className="heading-5 font-serif uppercase text-darkgray font-semibold mb-[25px] lg:mx-auto -tracking-[1px] w-[75%] xl:w-full lg:w-1/2 mx:xl-0 lg:mb-[15px] md:w-full">Special hotels for your trip</h2>
                  <p className="w-[75%] lg:mx-auto lg:text-center mb-[35px] xl:w-full lg:w-[65%] mx:xl-0 md:w-full sm:mb-[30px]">Lorem ipsum dolor sit consectetur adipiscing eiusmod tempor incididunt ut labore dolore magna ut tempor.</p>
                  <Buttons ariaLabel="link for hotels" href="#" className="btn-fancy btn-fill font-medium font-serif rounded-none uppercase md:mb-[15px]" themeColor="#232323" color="#fff" size="sm" title="explore hotels" />
                </m.div>
                <Col xl={9} lg={12}>
                  <InteractiveBanners08 className="" grid="row-cols-1 row-cols-md-2 row-cols-lg-3 gap-y-10 justify-center" data={InteractiveBannersData08} animation={fadeInLeft} />
                </Col>
              </Row>
            </Container>
          </section>
          ...
          <m.section className="py-[130px] overflow-hidden border-t border-mediumgray bg-gradient-to-b from-[#fff] via-[#fdfdfd] to-[#f7f7f7] lg:py-[90px] md:py-[75px] sm:py-[50px]" {...fadeIn}>
            <Container>
              <m.div className="row mb-20 md:mb-16 items-center" {...{...fadeIn,transition:{delay:0.2}}}>
                ...
                <Col lg={6} md={5} className="text-right sm:text-center">
                  <Buttons ariaLabel=" link for reviews" href="#" className="font-medium font-serif uppercase btn-link after:h-[2px] md:text-md md:mb-[15px] after:bg-darkgray hover:text-darkgray" color="#232323" title="See all reviews" size="xl" />
                </Col>
              </m.div>
              ...
              <m.div className="row justify-center" {...{...fadeIn,transition:{delay:0.6}}}>
                <Col lg={6} md={8} className="text-center">
                  <m.img width={555} height={43} src="/assets/img/webp/home-travel-agency-trustpilot.webp" alt="trustpilot" {...{ ...zoomIn, transition: { duration: 0.7 } }} />
                </Col>
              </m.div>
            </Container>
          </m.section>
          ...
          {/* Section Start */}
          <section className="py-[130px] pb-[200px] overflow-hidden cover-background lg:py-[90px] md:py-[75px] md:pb-[150px] sm:py-[50px] xs:h-auto" style={{ backgroundImage: `url(https://via.placeholder.com/1920x600)` }}>
            <div className="bg-darkslateblue top-0 left-0 absolute w-full h-full opacity-50"></div>
            <Container>
              <Row className="justify-center">
                <m.div className="text-center z-[1] col-xl-6 col-lg-7 col-sm-8" {...fadeIn}>
                  <span className="line-icon-Summer text-[60px] text-white mb-[30px] inline-block"></span>
                  <h2 className="heading-4 font-serif font-medium text-white -tracking-[1px] mb-[35px] xs:mb-[25px] xs:mx-auto xs:w-[90%]">Our tour packages are the <span className="font-semibold">easiest and <span className="underline">most efficient</span></span></h2>
                  <span className="font-serif font-medium text-white uppercase tracking-[2px]">Subscribe to have the journey!</span>
                </m.div>
              </Row>
            </Container>
          </section>
          ...
          <section className="pb-[130px] relative bg-white lg:pb-[90px] md:pb-[75px] sm:py-[50px]">
            <Container>
                          ...
                          {({ isSubmitting, status }) => (
                            <div className="relative subscribe-style-05">
                              <Form className="relative">
                                ...
                                <button aria-label="link for Subscribe" type="submit" className={`text-xs py-[12px] px-[28px] uppercase mr-[10px] xs:!mr-0 xs:text-center${isSubmitting ? " loading" : ""}`}><i className="far fa-envelope text-sm leading-none mr-[8px] xs:mr-0"></i>Subscribe</button>
                              </Form>
                              <AnimatePresence>
                                {status && <m.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute top-[115%] mt-[10px] left-0 w-full"><MessageBox className="rounded-[4px] text-md py-[10px] px-[22px]" theme="message-box01" variant="success" message="Your message has been sent successfully subscribed to our email list!" /></m.div>}
                              </AnimatePresence>
                            </div>
                          )}
                        </Formik>
              ...
              <m.div className="row mt-32 mb-20 md:mb-16 items-center" {...fadeIn}>
                <Col lg={6} md={7} className="text-left sm:text-center sm:mb-[10px]">
                  <h3 className="heading-5 font-serif font-semibold text-darkgray -tracking-[1px] uppercase mb-[5px]">Blogs on travelling</h3>
                  <p className="m-0 block">The hand picked posts for travelling enthusiasts</p>
                </Col>
                <Col lg={6} md={5} className="text-right sm:text-center">
                  <Buttons ariaLabel="link for Read all blogs" href="/blogs/blog-classic" className="font-medium font-serif uppercase btn-link after:h-[2px] lg:text-md after:bg-darkgray hover:text-darkgray" color="#232323" size="xl" title="Read all blogs" />
                </Col>
              </m.div>
              <Row>
                <Col>
        ...
        {/* Footer Start */}
        <FooterStyle10 className="text-slateblue" logo="/assets/img/webp/logo-neon-orange-white.webp" />
        {/* Footer End */}
      </div>
    )
  }
