...
const Wrapper = (props) => {
    ...
    }, []);  // Correcting missing dependencies
    ...
    }, [props.defaultOpen]);  // Correcting missing dependencies
    ...
    return (
        <div className={props.className}>
            ...
            <ReactModal
                ...
                ref={modalEl}
                isOpen={(customModal.el !== null && customModal.el === modalEl.current.node && customModal.isOpen === true)}
            ...
            >
                <div id="modal-outer" className="modal-outer w-full text-center py-[40px] px-[15px]">
                    {
...
// Define CustomModal object containing both components
const CustomModal = {
    Close,
    Wrapper
};
